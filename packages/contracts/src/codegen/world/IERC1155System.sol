...
interface IERC1155System {
  ...
  function ERC1155__safeTransferFrom(address from, address to, uint256 tokenId, uint256 value) external;
  ...
  function ERC1155__mint(address to, uint256 tokenId, uint256 value) external;

  function ERC1155__mint(address to, uint256 tokenId, uint256 value, bytes memory data) external;

  function ERC1155__setMetadataURI(string memory metadataURI) external;

  function ERC1155__safeMint(address to, uint256 tokenId, uint256 value) external;
  ...
  function ERC1155__totalSupply(uint256 tokenId) external view returns (uint256 _totalSupply);

  function ERC1155__currentSupply(uint256 tokenId) external view returns (uint256 _currentSupply);
